...
var _weatherApi = require("./weather_api");
...
function handleClick(e) {
    ...
    const { elements: { city, days } } = e.currentTarget;
    (0, _weatherApi.serviceWeather)(city.value, days.value).then((data)=>renderMarkup(data.forecast.forecastday));
}
...
},{"./weather_api":"34p0B"}],"34p0B":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "serviceWeather", ()=>serviceWeather);
...
async function serviceWeather(city, days) {
    ...
    try {
        const res = await (0, _axiosDefault.default).get(`${BASE_URL}?${params}`);
        return res.data;
    } catch (error) {
        console.log(error);
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fH7gS","8ZNvh"], "8ZNvh", "parcelRequireb482")
